...
let book=[new Book ("Harry potter","Yemo",1000,true),
     new Book ("Harry","Yeo",100,true),
     new Book ("Potter","emo",110,true) ,
     new Book ("HP","Yo",150,true),
      new Book ("The Hobbit","Hob",310,true)]
